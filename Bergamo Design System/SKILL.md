---
name: bergamo-design
description: Use this skill to generate well-branded interfaces and assets for BERGAMO — Open-Air · Container e.V., the two-night open-air music festival in Schwanfeld, Bavaria. Either for production or throwaway prototypes/mocks/social/posters. Contains essential design guidelines, colors, type, fonts, brand marks, and a website UI kit.
user-invocable: true
---
...
- **Palette is small and committed:** Container Orange (`#8B1E2D`) is THE accent against warm Paper (`#F4ECDD`), Ink (`#0B0E12`), and deep Night (`#101826`). No purple, no pastels, no gradients (except the single horizon wash documented).
...
- **The container is a character**, not a venue abstraction. Refer to it by name ("der Container", "Container e.V.").
